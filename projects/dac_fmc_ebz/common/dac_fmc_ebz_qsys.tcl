...
set CHANNEL_DATA_WIDTH [get_instance_parameter_value dac_jesd204_transport CHANNEL_DATA_WIDTH]

add_instance dac_upack util_upack
set_instance_parameter_values dac_upack [list \
  CHANNEL_DATA_WIDTH $CHANNEL_DATA_WIDTH \
  NUM_OF_CHANNELS $NUM_OF_CHANNELS \
]

add_connection dac_jesd204_link.link_clk dac_upack.if_dac_clk
...
set_instance_parameter_value avl_dac_fifo DAC_DATA_WIDTH [expr $NUM_OF_CHANNELS * $CHANNEL_DATA_WIDTH]
...
add_connection dac_upack.if_dac_valid avl_dac_fifo.if_dac_valid
add_connection avl_dac_fifo.if_dac_data dac_upack.if_dac_data
