...
set_module_property NAME axi_ad9208
set_module_property DESCRIPTION "AXI AD9208 Interface"
set_module_property VERSION 1.0
set_module_property GROUP "Analog Devices"
set_module_property DISPLAY_NAME axi_ad9208

# files

add_fileset quartus_synth QUARTUS_SYNTH "" "Quartus Synthesis"
set_fileset_property quartus_synth TOP_LEVEL axi_ad9208
...
add_fileset_file axi_ad9208.v               VERILOG PATH axi_ad9208.v TOP_LEVEL_FILE
...
ad_alt_intf signal  rx_sof        input   8 export

add_interface if_rx_data avalon_streaming sink
add_interface_port if_rx_data rx_data  data  input 256
...
set_interface_property if_rx_data dataBitsPerSymbol 256
...
add_interface_port adc_ch_0  adc_data_0    data     Output  128
...
add_interface_port adc_ch_1  adc_data_1    data     Output  128
